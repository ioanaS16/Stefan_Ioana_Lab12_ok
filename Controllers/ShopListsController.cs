...
namespace Stefan_Ioana_Lab12.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Stefan_Ioana_Lab12Context _context;

        public ShopListsController(Stefan_Ioana_Lab12Context context)
        {
            _context = context;
        }
